...
export default function RegisterCustomer() {
  ...
  const handleSearch = (event) => {
    ...
    specificApis.fetchPatientList(searchQuery,"email")
      ...
      <form onSubmit={handleSubmit}>
        <Stack spacing={20}>
          <Text fontSize="2xl" fontWeight="bold" mb={4}>Register Customer</Text>
            <Flex>
          <Input name="search" bg="black" color="blue.500" placeholder="Search by Patient ID, Email, or Mobile No" mb={4} onChange={handleInputChange}/>
