    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div key={item.id} className="space-y-4">
              ...
              {testReferenceValueTypes[index] === 'RANGE' && (
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label htmlFor={`tests.${index}.referenceValues[0].minAge`} className="block text-sm font-medium text-gray-700">Min Age</label>
                      <input {...register(`tests.${index}.referenceValues[0].minAge`)} className="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
                    </div>
                    <div>
                      <label htmlFor={`tests.${index}.referenceValues[0].maxAge`} className="block text-sm font-medium text-gray-700">Max Age</label>
                      <input {...register(`tests.${index}.referenceValues[0].maxAge`)} className="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
                    </div>
                    <div>
                      <label htmlFor={`tests.${index}.referenceValues[0].gender`} className="block text-sm font-medium text-gray-700">Gender</label>
                      <input {...register(`tests.${index}.referenceValues[0].gender`)} className="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
                    </div>
                    <div>
                      <label htmlFor={`tests.${index}.referenceValues[0].minReferenceValue`} className="block text-sm font-medium text-gray-700">Min Reference Value</label>
                      <input {...register(`tests.${index}.referenceValues[0].minReferenceValue`)} className="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
                    </div>
                    <div>
                      <label htmlFor={`tests.${index}.referenceValues[0].maxReferenceValue`} className="block text-sm font-medium text-gray-700">Max Reference Value</label>
                      <input {...register(`tests.${index}.referenceValues[0].maxReferenceValue`)} className="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
                    </div>
                    <div>
                      <label htmlFor={`tests.${index}.referenceValues[0].testResultUnit`} className="block text-sm font-medium text-gray-700">Test Result Unit</label>
                      <input {...register(`tests.${index}.referenceValues[0].testResultUnit`)} className="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
                    </div>
                  </div>
                </div>
              )}
      ...
      {testResultType === 'DOCUMENT' && (
        <div>
          ...
          <input {...register('document')} className="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
        </div>
      )}
          ...
          <div>
            ...
            {fields.map((column, columnIndex) => (
              <div key={column.id} className="grid grid-cols-2 gap-4">
                <input {...register(`matrixTestReportTemplate.columns.${columnIndex}.growth_measurement`)} className="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
                <input {...register(`matrixTestReportTemplate.columns.${columnIndex}.comments`)} className="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
                <button type="button" onClick={() => remove(columnIndex)} className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">Remove Column</button>
              </div>
            ))}
            <button type="button" onClick={() => append({})} className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Add Column</button>
          </div>
          <div>
            ...
            {fields.map((columnStyle, columnStyleIndex) => (
              <div key={columnStyle.id} className="grid grid-cols-4 gap-4">
                ...
                <button type="button" onClick={() => remove(columnStyleIndex)} className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">Remove Column Style</button>
              </div>
            ))}
            <button type="button" onClick={() => append({})} className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Add Column Style</button>
          </div>
          <div>
