...
{testResultType === 'MATRIX' && (
  <div>
    ...
    <input {...register(`tests.${index}.matrix.report_type`)} className="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
    <input {...register(`tests.${index}.matrix.primarySampleType`)} className="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
    <input {...register(`tests.${index}.matrix.description`)} className="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
    {/* Add more input fields for matrix here */}
  </div>
)}
