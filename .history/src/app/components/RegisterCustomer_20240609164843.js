          ...
          <ModalBody>
            <Stack spacing={4}>
              <FormControl>
                ...
                <Select name="referralType" bg="green" color="blue.500" onChange={handleInputChange} placeholder="Select type">
              ...
              <FormControl>
                ...
                <Input bg="green" color="blue.500" name="doctorHospitalName" onChange={handleInputChange} />
              </FormControl>
              <FormControl>
                <FormLabel>Degree</FormLabel>
                <Input name="degree" bg="green" color="blue.500" onChange={handleInputChange} />
              </FormControl>
              <FormControl>
                <FormLabel>Complements</FormLabel>
                <Textarea name="complements" bg="green" color="blue.500" onChange={handleInputChange} />
              </FormControl>
            </Stack>
          </ModalBody>
          <ModalFooter>
