...
export default function RegisterCustomer() {
  ...
  return (
    <main className="flex min-h-screen  flex-col items-center justify-center bg-red-700 w-full">
      ...
      <Modal isOpen={isOpen} onClose={onClose}  closeOnOverlayClick={false} bg="black" color="blue.500">
        <ModalOverlay />
        <ModalContent size="md" marginY="250" marginX="250" marginBottom="2500">
          ...
          <ModalBody>
            <Stack spacing={4}>
              <FormControl>
                ...
                <Select name="referralType" onChange={handleInputChange} placeholder="Select type">
              ...
              <FormControl>
                ...
                <Input name="doctorHospitalName" onChange={handleInputChange} />
              </FormControl>
              <FormControl>
              ...
              <FormControl>
                ...
                <Textarea name="complements" onChange={handleInputChange} />
              </FormControl>
            </Stack>
          </ModalBody>
          <ModalFooter>
