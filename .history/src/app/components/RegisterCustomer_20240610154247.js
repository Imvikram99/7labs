...
export default function RegisterCustomer() {
  ...
  const NewBill = ({ patientId, formData }) => {
    // Use patientId and formData here to display the bill
    return (
      <Box>
        <Text>Creating a bill for patient ID: {patientId}</Text>
        {/* More JSX to show the bill based on formData */}
      </Box>
    );
  };
