...
export default function RegisterCustomer() {
  ...
  const handleSearch = (event) => {
    ...
    const response = specificApis.fetchPatientList(formData.searchQuery,"email")
    onsole.log("search patient API response:", response);c
  ...
  >
    ...
    <option value="Ms">Ms.</option>
      ...
      <Modal isOpen={isOpen && activeModal === 'searchResults'} onClose={closeModal}>
        <ModalOverlay />
        <ModalContent>
          <ModalHeader>Patient Search Results</ModalHeader>
          <ModalCloseButton />
          <ModalBody>
