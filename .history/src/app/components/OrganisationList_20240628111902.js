      ...
      <div>
        ...
        {columnFields.map((column, columnIndex) => (
          <div key={column.id} className="mb-4">
            ...
            <input {...register(`matrixTestReportTemplate.columns.${columnIndex}.name`)} placeholder="Column Name" className="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
            <label className="block text-sm font-medium text-gray-700 mt-2">Key-Value Pairs</label>
            <div className="grid grid-cols-2 gap-4">
              <input {...register(`matrixTestReportTemplate.columns.${columnIndex}.growth_measurement`)} placeholder="Growth Measurement" className="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
              <input {...register(`matrixTestReportTemplate.columns.${columnIndex}.comments`)} placeholder="Comments" className="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
            </div>
          </div>
        ))}
